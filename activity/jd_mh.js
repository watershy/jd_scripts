...
[task_local]
#盲盒抽京豆
1 7 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_mh.js, tag=盲盒抽京豆, img-url=https://raw.githubusercontent.com/yogayyy/Scripts/master/Icon/shylocks/jd_mh.jpg, enabled=true================Loon==============
[Script]
cron "1 7 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_mh.js,tag=盲盒抽京豆===============Surge=================
盲盒抽京豆 = type=cron,cronexp="1 7 * * *",wake-system=1,timeout=200,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_mh.js============小火箭=========
 ...
 */
const $ = new Env('盲盒抽京豆');const ck = require('./jdCookie')//IOS等用户直接用NobyDa的jd cookie
let cookiesArr = [], cookie = '', message;!(async () => {
