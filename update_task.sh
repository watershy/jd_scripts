#!/usr/bin/env bash## Author: https://github.com/EvineDeng
## Modified： 2021-01-22
## Version： v1.0.1## 路径与清单
...
FileSurge=$WorkDir/Surge/lxk0301_Task.sgmodule.sgmodule## task清单顶部内容
