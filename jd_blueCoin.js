...
[task_local]
#东东超市兑换奖品
0 0 0 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_blueCoin.js, tag=东东超市兑换奖品, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true====================Loon=================
[Script]
cron "0 0 0 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_blueCoin.js,tag=东东超市兑换奖品===================Surge==================
东东超市兑换奖品 = type=cron,cronexp="0 0 0 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_blueCoin.js============小火箭=========
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.data.bizCode === 0) {
              ...
              $.notice += `【总金币】${$.totalGold}个\n`
              $.notice += `【总蓝币】${$.totalBlue}个\n`
            }
          }
        }
      } catch (e) {
